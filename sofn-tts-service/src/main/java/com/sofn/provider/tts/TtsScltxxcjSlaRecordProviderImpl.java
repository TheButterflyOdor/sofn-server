...
public class TtsScltxxcjSlaRecordProviderImpl extends BaseProviderImpl<TtsScltxxcjSlaRecord> implements TtsScltxxcjSlaRecordProvider {
    ...
    @Override
    public PageInfo findById(Map<String, Object> params) {
        PageInfo pageInfo = new PageInfo();
        List<Map<String,Object>> list = ttsScltxxcjSlaRecordExpandMapper.findById(params);
        long count = ttsScltxxcjSlaRecordExpandMapper.findCount(params);
