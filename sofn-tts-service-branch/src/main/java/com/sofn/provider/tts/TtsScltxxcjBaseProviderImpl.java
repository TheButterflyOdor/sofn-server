...
public class TtsScltxxcjBaseProviderImpl extends BaseProviderImpl<TtsScltxxcjBase> implements TtsScltxxcjBaseProvider {
    ...
    @Override
    public void batchDeleteByIds(String[] ids) { TtsScltxxcjBaseExpandMapper.batchRemoveByIds(ids);}
    ...
    @Override
    public boolean isExistedBase(TtsScltxxcjBase tscltxxcjbase) {
        long countPro = TtsScltxxcjBaseExpandMapper.isExistedBase(tscltxxcjbase);
