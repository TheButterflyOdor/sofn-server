...
public interface TtsScltxxcjCgglExpandMapper extends BaseExpandMapper {
     ...
     * @param map
     */
    List<TtsScltxxcjCgglAndCustomer> getCgglForZsm(Map<String, Object> map);
     ...
     * @return
     */
    SamplingInfo getSamplingInfoByTraceCode(@Param("code") String code);

    List<TtsScltxxcjXsdjAndCustomer> getAllPurchase(Map<String, Object> map);
}
