...
public interface TtsScltxxcjXcdjjlExpandMapper extends BaseExpandMapper {
	...
	*/
     ...
     * @return
     */
    List<Map<String,Object>> getInfoBypc(Map<String,Object> map);
     ...
     * @return
     */
    List<Map<String,Object>> getHclx(Map<String,Object> pc);

    List<Map<String,Object>> getPageInfoPrint(Map<String, Object> map);

    long getPrintCount(Map<String, Object> map);
