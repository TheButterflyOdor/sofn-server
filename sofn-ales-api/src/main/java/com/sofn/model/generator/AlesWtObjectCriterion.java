...
public class AlesWtObjectCriterion extends BaseModel {
    private String enable;//是否删除

    private String objectId;//检测对象id

    private String taskId;//任务id

    private String criterionName;//标准名称

    private String criterionId;//标准id
    ...
    public boolean equals(Object that) {
        ...
        AlesWtObjectCriterion other = (AlesWtObjectCriterion) that;
