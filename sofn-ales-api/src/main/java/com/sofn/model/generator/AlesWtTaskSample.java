...
public class AlesWtTaskSample extends BaseModel {
    private String wtTaskId;//
    ...
    public String getWtTaskId() {
        return wtTaskId;
    }

    public void setWtTaskId(String wtTaskId) {
        this.wtTaskId = wtTaskId == null ? null : wtTaskId.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", wtTaskId=").append(wtTaskId);
        sb.append(", productTraceabilityCode=").append(productTraceabilityCode);
        ...
        sb.append(", specificationGx=").append(specificationGx);
        ...
        sb.append(", commentGx=").append(commentGx);
        ...
        sb.append(", producingAreaName=").append(producingAreaName);
    ...
    public boolean equals(Object that) {
        ...
        AlesWtTaskSample other = (AlesWtTaskSample) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getWtTaskId() == null ? other.getWtTaskId() == null : this.getWtTaskId().equals(other.getWtTaskId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getWtTaskId() == null) ? 0 : getWtTaskId().hashCode());
