...
public class TtsScltxxcjUserChangeRecord extends BaseModel {
	...
	*/
    ...
    public String updateBeforeJson; //变更前内容JSON
    public String unit; //企业年产量计量单位
    public String unitName; //企业年产量计量单位NAME
    public String entityId; //主体ID
    public String account; //姓名
    ...
    public String enterpriseName; //变更前内容JSON
    ...
    public String approveType; //变更类型
    public String reason; //变更原因
    public String updateContent; //变更详细情况
    public String applyUserId; //申请人用户ID
    public String applyUpdateName; //申请人
    public String applyUpdateEntityIdcode; //申请人主体身份码
    public String applyUpdateUserIdcode; //申请人主体用户码
    public Date applyUpdateTime; //申请时间
