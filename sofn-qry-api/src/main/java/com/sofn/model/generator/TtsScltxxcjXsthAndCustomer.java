...
public class TtsScltxxcjXsthAndCustomer extends TtsScltxxcjXsth {
    ...
    private String harverestUnit;//单位
    ...
    public String getHarverestUnit() {
        return harverestUnit;
    }

    public void setHarverestUnit(String harverestUnit) {
        this.harverestUnit = harverestUnit;
    }
    @Override
    public String toString() {
        ...
        sb.append(", harverestUnit=").append(harverestUnit);
        sb.append("]");
        return sb.toString();
    }
    ...
    public boolean equals(Object that) {
        ...
        return
                (this.getXsjlid() == null ? other.getXsjlid() == null : this.getXsjlid().equals(other.getXsjlid())) &&
                        ...
                        (this.getHarverestUnit() == null ? other.getHarverestUnit() == null : this.getHarverestUnit().equals(other.getHarverestUnit())) &&
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getHarverestUnit() == null) ? 0 : getHarverestUnit().hashCode());
        return result;
    }
}
