...
public class TtsScltxxcjRegiterAndUser extends BaseModel {
	...
	*/
    ...
    public String childId;//验证码

    public String longinAccount; //登录账号
    public String childUserIdcode; //user表中主体用户码
    public String isMain; //是否是主账号
    public String status; //账号审核状态
