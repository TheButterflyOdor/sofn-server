...
public class TtsScltxxcjCggl extends BaseModel {
	...
	*/	
	...
	public String productId; //产品名称编号
	public String productIndustry; //产品行业
	public String productSort; //分类
	public String productScglId; //产品批次
	public BigDecimal cgAmount; //采购数量
	public String entityIdcode; //主体身份码
	public String userIdcode; //主体用户码
	public String saleEntityIdcode; //销售主体身份码
	public String saleUserIdcode; //销售主体用户码
	public String cgDw; //采购计量单位
	public String confirmState; //确认状态
	public String traceCode; //产品追溯码
	public String zjresult; //质检结论
	public Date saleTime; //采购时间
	...
	public String productCgpc; //采购批次ID
	public String productCgpcSl; //采购批次数量
    ...
    */
    ...
    public boolean equals(Object that) {
        ...
        TtsScltxxcjCggl other = (TtsScltxxcjCggl) that;
          return 
