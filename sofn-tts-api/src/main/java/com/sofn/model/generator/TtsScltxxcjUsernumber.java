...
public class TtsScltxxcjUsernumber extends BaseModel {
    private String entityIdcode;//实体身份码

    private BigDecimal userNumber;//用户号
    ...
    public boolean equals(Object that) {
        ...
        TtsScltxxcjUsernumber other = (TtsScltxxcjUsernumber) that;
