...
public class AsmsSubjSvChange extends BaseModel implements Serializable {
    ...
    private String changeBeforeField;
    ...
    public String getChangeBeforeField() {
        return changeBeforeField;
    }

    public void setChangeBeforeField(String changeBeforeField) {
        this.changeBeforeField = changeBeforeField == null ? null : changeBeforeField.trim();
    }
    ...
    public void setSvFileName(String svFileName) {
        this.svFileName = svFileName == null ? null : svFileName.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", changeBeforeField=").append(changeBeforeField);
        ...
        sb.append(", svFileName=").append(svFileName);
   ...
   @Override
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getChangeBeforeField() == null ? other.getChangeBeforeField() == null : this.getChangeBeforeField().equals(other.getChangeBeforeField()))
            ...
            && (this.getSvFileName() == null ? other.getSvFileName() == null : this.getSvFileName().equals(other.getSvFileName()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getChangeBeforeField() == null) ? 0 : getChangeBeforeField().hashCode());
        ...
        result = prime * result + ((getSvFileName() == null) ? 0 : getSvFileName().hashCode());
