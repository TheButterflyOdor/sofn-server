...
public class AsmsSubjElRevoke extends BaseModel {
    private String elId;
    ...
    public boolean equals(Object that) {
        ...
        AsmsSubjElRevoke other = (AsmsSubjElRevoke) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getElId() == null ? other.getElId() == null : this.getElId().equals(other.getElId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getElId() == null) ? 0 : getElId().hashCode());
