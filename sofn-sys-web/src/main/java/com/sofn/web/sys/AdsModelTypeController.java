...
import com.sofn.service.sys.AdsModelTypeService;
...
public class AdsModelTypeController extends BaseController {
    ...
    @SystemControllerLog(description = "获取模型_种类信息列表",operationType="查询")
    ...
    @SystemControllerLog(description = "新增模型_种类数据",operationType="新增")
    ...
    @SystemControllerLog(description = "获取单条模型_种类数据信息",operationType="查询")
    ...
    @SystemControllerLog(description = "修改模型_种类数据信息",operationType="修改")
    ...
    @SystemControllerLog(description = "删除模型_种类信息",operationType="删除")
    ...
    @SystemControllerLog(description = "批量删除模型_种类数据",operationType="删除")
