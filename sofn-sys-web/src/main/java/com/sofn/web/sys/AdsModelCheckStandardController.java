...
import com.sofn.service.sys.AdsModelCheckStandardService;
...
public class AdsModelCheckStandardController extends BaseController {
    ...
    @SystemControllerLog(description = "新增模型_检测标准数据",operationType="新增")
    ...
    @SystemControllerLog(description = "获取单条模型_检测标准数据信息",operationType="查询")
    ...
    @SystemControllerLog(description = "修改模型_检测标准数据信息",operationType="修改")
    ...
    @SystemControllerLog(description = "删除模型_检测标准信息",operationType="删除")
    ...
    @SystemControllerLog(description = "批量删除模型_检测标准数据",operationType="删除")
