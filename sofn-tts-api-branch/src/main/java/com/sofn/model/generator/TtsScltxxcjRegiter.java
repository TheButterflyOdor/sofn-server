...
public class TtsScltxxcjRegiter extends BaseModel {
	...
	*/	
    ...
    private String approveStatus; //审批状态（0:注册待审核;1:审核通过;2:注册审核不通过;3变更待审核;4:注销待审核;5:撤销审核;6:撤销通过;7:已注销）
    ...
    private String annualOutput; //企业种植业年产量
    private String unit; //企业种植业年产量计量单位
    ...
    private String infoUnique;//该字段为冗余字段，只用于防止注册信息出现重复的情况。
    ...
    private String childWhetherPassword;//用户是否继续接收系统提示修改初始密码的弹窗。0表示继续弹窗提示，1表示忽略
    private String childCheckEditPassword;//用户是否已经修改了初始密码。0表示未修改，1表示已修改，当该字段值为1时，
    private String childId;
    private String organizationCode; //组织机构代码
    private String isLong;//是否是长期
    private String annualOutputX;//企业畜牧业年产量
    private String annualOutputS;//企业水产品年产量
    private String unitX;//企业畜牧业年产量单位
    private String unitS;//企业水产品年产量单位
    private String unitNameX;//企业畜牧业年产量单位名称
    private String unitNameS;//企业水产品年产量单位名称
    ...
    public String getChildCheckEditPassword() {
        return childCheckEditPassword;
    }

    public void setChildCheckEditPassword(String childCheckEditPassword) {
        this.childCheckEditPassword = childCheckEditPassword;
    }

    public String getChildWhetherPassword() {
        return childWhetherPassword;
    }

    public void setChildWhetherPassword(String childWhetherPassword) {
        this.childWhetherPassword = childWhetherPassword;
    }
    ...
    public String toString() {
        ...
        sb.append(", childWhetherPassword='").append(childIdcard).append('\'');
        sb.append(", childCheckEditPassword='").append(childIdcard).append('\'');
        sb.append(", organizationCode='").append(organizationCode).append('\'');
        sb.append(", isLong='").append(isLong).append('\'');
        sb.append(", annualOutputX='").append(isLong).append('\'');
        sb.append(", annualOutputS='").append(isLong).append('\'');
        sb.append(", unitX='").append(isLong).append('\'');
        sb.append(", unitS='").append(isLong).append('\'');
        sb.append(", unitNameX='").append(isLong).append('\'');
        sb.append(", unitNameS='").append(isLong).append('\'');
        sb.append('}');
        return sb.toString();
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + (getChildWhetherPassword() != null ? getChildWhetherPassword().hashCode() : 0);
        result = 31 * result + (getChildCheckEditPassword() != null ? getChildCheckEditPassword().hashCode() : 0);
        ...
        result = 31 * result + (getAnnualOutputX() != null ? getAnnualOutputX().hashCode() : 0);
        result = 31 * result + (getAnnualOutputS() != null ? getAnnualOutputS().hashCode() : 0);
        result = 31 * result + (getUnitNameX() != null ? getUnitNameX().hashCode() : 0);
        result = 31 * result + (getUnitNameS() != null ? getUnitNameS().hashCode() : 0);
        result = 31 * result + (getUnitX() != null ? getUnitX().hashCode() : 0);
