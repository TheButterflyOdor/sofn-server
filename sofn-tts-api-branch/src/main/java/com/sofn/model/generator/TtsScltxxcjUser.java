...
public class TtsScltxxcjUser extends BaseModel {
	...
	*/	
    ...
    private String whetherPassword;//用户是否继续接收系统提示修改初始密码的弹窗。0表示继续弹窗提示，1表示忽略
    private String checkEditPassword;//用户是否已经修改了初始密码。0表示未修改，1表示已修改，当该字段值为1时，WHETHER_PASSWORD字段的值也必须为1
    ...
    */
    ...
    public String getCheckEditPassword() {
        return checkEditPassword;
    }

    public void setCheckEditPassword(String checkEditPassword) {
        this.checkEditPassword = checkEditPassword;
    }

    public String getWhetherPassword() {
        return whetherPassword;
    }

    public void setWhetherPassword(String whetherPassword) {
