...
public interface TtsScltxxcjRegiterProvider extends BaseProvider<TtsScltxxcjRegiter> {
    ...
    List<TtsScltxxcjRegiter> getSubList(Map<String, Object> map);
     ...
     * @return Integer
     */
    Integer updateEntityByEntity(Map<String, Object> map, String token) throws Exception;
...
//	TtsScltxxcjRegiter getBodyInfoByUserCode(String code,String userType);
    ...
    TtsScltxxcjRegiter findInfoByCreditCode(Map<String, Object> params);
    ...
    int insertSubj(TtsScltxxcjRegiter subj);
