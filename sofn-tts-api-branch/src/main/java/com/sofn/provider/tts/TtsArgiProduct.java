 ...
 */
public class TtsArgiProduct extends BaseModel {
    ...
    private BigDecimal slaughterAmount;
    private String proofNumber;
    private String harvestUnit;

    public BigDecimal getSlaughterAmount() {
        return slaughterAmount;
    }

    public void setSlaughterAmount(BigDecimal slaughterAmount) {
    ...
    public boolean equals(Object that) {
        ...
        TtsArgiProduct other = (TtsArgiProduct) that;
